            ...
            <form wire:submit.prevent="submit">
                ...
                <div class="flex flex-wrap -mx-2">
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-select :options="$libros" option-value="N" option-label="DESCRIPCION" label="Libro" id="libro" wire:model="libro"  placeholder="Seleccionar tipo de libro" />
                    </div>
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-datetime-picker without-time  placeholder="Appointment Date" label="Fecha del Documento"   id="fecha_doc" wire:model="fecha_doc" required />
                    </div>
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-datetime-picker without-time  placeholder="Appointment Date" label="Fecha Vec Doc"  id="fecha_ven" wire:model="fecha_ven" required />
                    </div>
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-datetime-picker without-time  placeholder="Appointment Date" label="Fecha de vaucher"  id="fecha_ven" wire:model="fecha_vaucher" required />
                    </div>
                ...
                <div class="flex flex-wrap -mx-2">
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-select :options="$ComprobantesPago"  option-value="N" option-label="DESCRIPCION" label="Tipo doc de pago" id="tdoc" wire:model="tdoc"  placeholder="Seleccionar tipo de documento de pago" required />
                    </div>
                    <div class="w-full md:w-3/12 px-2 mb-4">
                ...
                <div class="flex flex-wrap -mx-2">
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-select :options="$opigvs" option-label="Descripcion" option-value="Id" label="Tipo de Op IGV" id="opigv" wire:model="opigv"    placeholder="Seleccionar tipo op IGV" required />
                    </div>
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-select
    label="Porcentaje Base Imp"
    id="bas_imp_percentage"
...
/>
                    ...
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-input   label="Base Imponible" id="bas_imp" wire:model.live="bas_imp" class="numeric-input" required />
                    </div>
                    <div class="w-full md:w-3/12 px-2 mb-4">
                ...
                <div class="flex flex-wrap -mx-2">
                    ...
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-input  label="Importe Bol. Pla." id="imp_bol_pla" wire:model.live="imp_bol_pla" class="numeric-input" />
                    </div>
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-input    label="Otro Tributo" id="otro_tributo" wire:model.live="otro_tributo" class="numeric-input" />
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-2">
                    ...
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-input label="Fecha Emi Detracción" id="fec_emi_detr" type="date" wire:model="fec_emi_detr" />
                    </div>
                    <div class="w-full md:w-3/12 px-2 mb-4">
                    ...
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-select
    label="Tiene Detracción?"
    id="tiene_detracc"
    wire:model="tiene_detracc"
...
/>
                ...
                <div class="flex flex-wrap -mx-2">
                    ...
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-select :options="$estado_docs" option-value="id" option-label="descripcion" label="Estado Doc" id="estado_doc" wire:model="estado_doc"  placeholder="Selecciona Estado doc" required />
                    </div>
                    <div class="w-full md:w-3/12 px-2 mb-4">
                        <x-select :options="$estados" option-value="N" option-label="DESCRIPCION" label="Estado" id="estado" wire:model="estado"    placeholder="Seleccione el estado" required />
                    </div>
                </div>
