<div>
    ...
    <x-button label="Mostrar/Ocultar Formulario" wire:click="toggleFormulario" class="mb-4" />
    <div class="@if(!$mostrarFormulario) hidden @endif">
            <x-card title="Compra Venta Formulario">
                <form wire:submit.prevent="submit">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Serie" id="ser" wire:model="ser" maxlength="4" oninput="this.value = this.value.toUpperCase()" />
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Número" id="num" wire:model="num" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required />
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="No Gravadas" id="no_gravadas" wire:model.live="no_gravadas" class="numeric-input" />
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Cuenta 1" id="cnta1" wire:model="cnta1.cuenta" wire:keydown.f2="modal(1)" required/>
                            @livewire('cuadro-de-cuentas')
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Cuenta 2" id="cnta2" wire:model="cnta2.cuenta" wire:keydown.f2="modal(2)" />
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Cuenta 3" id="cnta3" wire:model="cnta3.cuenta" wire:keydown.f2="modal(3)" />
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Cuenta Precio" id="cnta_precio" wire:model="cnta_precio.cuenta" wire:keydown.f2="modal(4)" required/>
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Centro de Costo 1" id="cc1" wire:model="cc1" wire:keydown.f2="modalCentroCostos(1)"/>
                            @livewire('modal-centro-de-costos')
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Centro de Costo 2" id="cc2" wire:model="cc2" wire:keydown.f2="modalCentroCostos(2)"/>
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Centro de Costo 3" id="cc3" wire:model="cc3" wire:keydown.f2="modalCentroCostos(3)"/>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Cuenta Otro Tributo" id="cta_otro_t" wire:model="cta_otro_t.cuenta" wire:keydown.f2="modal(5)"/>
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Fecha de Mod" id="fecha_emod" type="date" wire:model="fecha_emod" />
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-select :options="$ComprobantesPago" option-value="N" option-label="DESCRIPCION" label="Tipo Doc Modificado"
                                id="tdoc_emod" wire:model="tdoc_emod" placeholder="Seleccionar tipo de documento de pago" required />
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-full md:w-3/12 px-2 mb-4">
                            <x-input label="Cuenta de Detracción" id="cta_detracc" wire:model="cta_detracc.cuenta" wire:keydown.f2="modal(6)" />
                        </div>
                        <div class="w-full md:w-3/12 px-2 mb-4">
