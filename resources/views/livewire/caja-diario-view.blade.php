<div>
    <x-card>
        <h1 class="font-bold">Caja diario</h1>
    </x-card>
        ...
        <div class="flex flex-wrap justify-center gap-2">
                ...
                <div class="w-full md:w-5/12">
                    <div class="text-sm font-bold flex items-center">
                        ...
                        <x-select label="libro" class="flex-1 w-full" :options="$libro" option-value="N" option-label="DESCRIPCION"
                            id="libro" wire:model="libro" placeholder="Seleccionar tipo de libro" />
                    </div>
                    <div class="text-sm font-bold flex items-center">
                        
                        <x-select label="mes" class="flex-1 w-full" :options="$mes" option-value="N" option-label="MES" id="mes"
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden max-w-full">
            ...
            <div class="p-4 overflow-x-auto">
                <table class="min-w-full bg-white border border-gray-200">
                    <thead>
                        <tr>
                            <th class="py-2 px-4 bg-gray-200 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                                MES
                            </th>
                            <th class="py-2 px-4 bg-gray-200 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                                DESCRIPCION
