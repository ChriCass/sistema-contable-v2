...
class ModalidadServicioSujetoNodomiciliado extends Model
{
    use HasFactory;

    protected $table = 's_tabla32_modalidaddelservicioprestadoporelsujetonodomiciliado';  // Especifica el nombre exacto de la tabla
