...
class TipoVinculacionEconomica extends Model
{
    use HasFactory;

    protected $table = 's_tabla27_tipodevinculacioneconomica';  // Especifica el nombre exacto de la tabla
    ...
    protected $fillable = [
        'N', 'DESCRIPCION', 'TVinEconoArticulosDS122-94-EF'  // Permite la asignación masiva en estos campos
    ];
