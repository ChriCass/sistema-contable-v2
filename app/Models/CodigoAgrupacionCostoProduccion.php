...
class CodigoAgrupacionCostoProduccion extends Model
{
    use HasFactory;

    protected $table = 's_tabla21_codigodeagrupdelcostodeproducvalanual';  // Especifica el nombre exacto de la tabla
